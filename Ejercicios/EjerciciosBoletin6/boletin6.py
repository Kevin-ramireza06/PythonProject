...
regex = r"^\+[0-9]{2} [0-9]{9}$" #El signo “+” lleva la barra \ atras para que no se interprete como un operador de regex
                                 #El regex entiende que debe de haber un espacio literalmente en donde lo pusimos
if re.fullmatch(regex, entrada):
    print("valido")
else:
    print("no valido")
